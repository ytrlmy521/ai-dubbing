...
请严格按照上述要求，只将下面这一行中文文本翻译成美式英语，并直接返回翻译结果，仅返回译文，不要添加任何额外的解释或说明：
{text_to_translate}
"""
...
类似这种中文的额外注释不需要返回：（注：根据技术规范要求，爆破音"bond"对应中文闭口字"和"，长元音"find"对应开口字"有"，音节数7:7完全匹配，维多利亚句式"be it...or"保留30%中文语序浪漫感，[!]标记气口与原声"好/局"停顿对齐）
...
请严格按照上述要求，只将下面这一行中文文本翻译成英式英语，并直接返回翻译结果，仅返回译文，不要添加任何额外的解释或说明：
{text_to_translate}
"""
